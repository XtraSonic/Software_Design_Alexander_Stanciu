 ...
 * @author XtraSonic
 */
public class JDBCTournamentDAO implements TournamentGateway {
    ...
    public int insert(Tournament tournament)
    {
        ...
        try
        {
            ...
            statement.setObject(2, Date.valueOf(tournament.getStartDate()));
            statement.setInt(3, tournament.getPrizePool());
    ...
    public void update(Tournament tournament)
    {
        ...
        try
        {
            ...
            statement = connection.prepareStatement(sqlQuery);
            statement.setString(1, tournament.getName());
            statement.setObject(2, tournament.getStartDate());
            statement.setInt(3, tournament.getPrizePool());
