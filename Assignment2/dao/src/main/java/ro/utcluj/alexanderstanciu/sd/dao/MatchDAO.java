 ...
 * @author XtraSonic
 */
public class MatchDAO implements MatchGateway{
    ...
    public int insert(Match pingpong_match)
    {
        ...
        try
        {
            ...
            statement.setInt(1, pingpong_match.getGame_id());
            statement.setInt(2, pingpong_match.getPlayer1_score());
            statement.setInt(3, pingpong_match.getPlayer2_score());
