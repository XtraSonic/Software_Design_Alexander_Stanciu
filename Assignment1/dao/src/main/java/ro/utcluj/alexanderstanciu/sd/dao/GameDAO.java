 ...
 * @author XtraSonic
 */
public class GameDAO implements GameGateway {
    ...
    public int insert(Game game)
    {
        ...
        try
        {
            ...
            statement.setInt(1, game.getTournament_id());
            statement.setInt(2, game.getPlayer1_id());
            statement.setInt(3, game.getPlayer2_id());
